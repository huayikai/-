...
from .KaleidoscopeAgent import KaleidoscopeAgent
from .dave_rnn_agent import DAVERNNAgent
...
REGISTRY["KaleidoscopeAgent"] = KaleidoscopeAgent
REGISTRY["dave_rnn"] = DAVERNNAgent